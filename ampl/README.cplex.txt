...
above single-word phrases, denoting them with "Single-word phrase".
     ...
     auxrootthreads     New in CPLEX 12.2.  Controls the number of threads
     ...
     mcfcuts            New in CPLEX 12.0.  Whether to use multi-commodity
                        flow (MCF) cuts:
                                -1 = no
     ...
     mipkappa           Whether to compute statistics on the condition
     ...
     parallelmode       Parallel optimization mode:  new in CPLEX 11:
     ...
     probetimedet       New in CPLEX 12.5.  Limit in "ticks" on time spent
                        probing.  Default = 1e75.
     ...
     qctol3             Tolerance on the reduction during QR factorization of
                        the maxnorm of an "active" constraiont's gradient
     ...
     reqconvex          New in CPLEX 12.3.  Whether to require a quadratic
                        model to be convex:
                                0 = automatic choice (default)
                                1 = require convexity
...
solve_message.
        ...
        130     locally optimal solution (of an indefinite QP)
